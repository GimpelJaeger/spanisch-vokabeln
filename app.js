...
<head>
    ...
    <style>
        ...
        .learn-card.card-correct {
            background: #c8f7c5;
        }

        .learn-card.card-wrong {
            background: #f8c4c4;
        }
        ...
        .learn-card.show-back .card-front {
            display: none;
        }

        .learn-card.show-back .card-back {
            display: flex;
        }
...
<body>
    ...
    <div class="card-block">
        ...
        <p>
            Es wird ein Stapel von bis zu 10 Karten erstellt. Zuerst siehst du das deutsche Wort,
            dann kannst du auf „Umdrehen“ klicken. Auf der Rückseite entscheidest du mit
            „Gewusst“ oder „Nicht gewusst“. Der Stapel geht erst weiter, wenn du „Weiter“ klickst.
            Auf der Rückseite kannst du zusätzlich nach links / rechts wischen.
        </p>
    ...
    <div id="learnOverlay" class="overlay hidden">
        <div class="overlay-inner">
            ...
            <div id="cardArea">
                ...
                <!-- Buttons auf Vorderseite -->
                <div id="cardButtonsFront" class="card-buttons-row">
                    <button id="btnFlipCard">Umdrehen</button>
                </div>

                <!-- Buttons auf Rückseite -->
                <div id="cardButtonsBack" class="card-buttons-row hidden">
                    <button id="btnMarkWrong">Nicht gewusst</button>
                    <button id="btnMarkCorrect">Gewusst</button>
                </div>

                <button id="btnNextCard" disabled>Weiter</button>
            </div>
